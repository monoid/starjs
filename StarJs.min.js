...
(function(b){b.apply=function(c){var d=this.mat[0],f=d[0]*c.x+d[1]*c.y+d[2]*c.z;d=this.mat[1];var e=d[0]*c.x+d[1]*c.y+d[2]*c.z;d=this.mat[2];return new a.b.l(f,e,d[0]*c.x+d[1]*c.y+d[2]*c.z)};b.H=function(c){var d=[[0,0,0],[0,0,0],[0,0,0]];c=c.mat;for(var f=0;3>f;f+=1)for(var e=this.mat[f],g=d[f],k=0;3>k;k+=1)for(var p=0;3>p;p+=1)g[k]+=e[p]*c[p][k];return new a.b.g(d,!0)}})(a.b.g.prototype);a.b.g.o=function(b){var c=Math.cos(b);b=Math.sin(b);return new a.b.g([[1,0,0],[0,c,b],[0,-b,c]])};
a.b.g.G=function(b){var c=Math.cos(b);b=Math.sin(b);return new a.b.g([[c,0,-b],[0,1,0],[b,0,c]])};a.b.g.A=function(b){var c=Math.cos(b);b=Math.sin(b);return new a.b.g([[c,b,0],[-b,c,0],[0,0,1]])};a.j={};a.j.DEFAULT_JULIAN_DATE={year:1582,month:10,day:4};a.j.DEFAULT_JULIAN_JD=2299161;a.j.JD_MJD=2400000.5;a.j.ya=function(b){"number"!==typeof b&&(b=b.getTime());return b/864E5+40587};
...
a.f.ta=function(b,c,d,f,e,g){var k=Math.abs(1-e);var p=k/f;var l=Math.sqrt(b)*(d-c)*Math.sqrt(p*p*p);b=.1>l&&.1>k?a.f.aa(b,c,d,f,e):1>e?a.f.P(b,l,1/p,e):a.f.$(b,c,d,1/p,e);return g.apply(b)};a.f.V=function(b,c,d){return a.b.g.A(-b).H(a.b.g.o(-c)).H(a.b.g.A(-d))};a.c={};a.c.M=23.43920111*a.Math.u;
...
a.c.F=function(b){var c=a.Math.B(.993133+99.997361*b);var d=a.Math.v*c;b=a.b.g.o(-a.c.M).apply((new a.b.s(a.Math.v*a.Math.B(.7859453+c+(6893*Math.sin(d)+72*Math.sin(2*d)+6191.2*b)/1296E3),0)).o());b=new a.b.s(b);return{ra:b.phi,dec:b.theta}};
a.c.fa=[{body:"moon",name:"day",title:"Moon",sinh0:Math.sin(8/60*a.Math.u),posFunc:a.c.J},{body:"sun",name:"day",title:"Sun",sinh0:Math.sin(-50/60*a.Math.u),posFunc:a.c.F},{body:"sun",name:"twilightC",title:"Civil twilight",sinh0:Math.sin(-6*a.Math.u),posFunc:a.c.F},{body:"sun",name:"twilightN",title:"Nautical twilight",sinh0:Math.sin(-12*a.Math.u),posFunc:a.c.F},{body:"sun",name:"twilightA",title:"Astronomical twilight",sinh0:Math.sin(-18*a.Math.u),posFunc:a.c.F}];
a.c.xa=function(b,c,d,f,e){function g(x,B,D,E,F){x=x((B-51544.5)/36525);return F*Math.sin(x.dec)+E*Math.cos(x.dec)*Math.cos(a.j.W(B)+D-x.ra)}var k=a.c.fa,p=[],l,n,y=1/24,r={},v={},z={},t=Math.cos(f);f=Math.sin(f);var q={sun:{},moon:{}},C={sun:{},moon:{}},A={sun:{},moon:{}},u={};"undefined"===typeof e&&(e=function(x){return x});var w=b;r.moon=g(a.c.J,w,d,t,f);r.sun=g(a.c.F,w,d,t,f);for(n=0;n<k.length;n+=1){var h=k[n];var m=h.name;q[h.body][m]=r[h.body]-h.sinh0}for(;w<c;){e={moon:{midnight:r.moon},
sun:{midnight:r.sun}};for(l=1;24>l;l+=2){n=w+y;w=n+y;v.moon=g(a.c.J,n,d,t,f);v.sun=g(a.c.F,n,d,t,f);z.moon=g(a.c.J,w,d,t,f);z.sun=g(a.c.F,w,d,t,f);for(n=0;n<k.length;n+=1)switch(h=k[n],m=h.name,e[h.body][m]=e[h.body][m]||{},C[h.body][m]=v[h.body]-h.sinh0,A[h.body][m]=z[h.body]-h.sinh0,u=a.Math.ba(q[h.body][m],C[h.body][m],A[h.body][m]),u.roots.length){case 1:0>q[h.body][m]?e[h.body][m].rise=l+u.roots[0]:e[h.body][m].set=l+u.roots[0];break;case 2:0>u.ye?(e[h.body][m].rise=l+u.roots[1],e[h.body][m].set=
...
n:3033.6272,O:100.4908,i:1.3046,w:15.5576,T0:0}),Saturn:new a.c.Body("Saturn",{a:9.582018,e:.055723,M0:320.3477,n:1213.8664,O:113.6427,i:2.4852,w:89.6567,T0:0}),Uranus:new a.c.Body("Uranus",{a:19.229412,e:.044406,M0:142.9559,n:426.9282,O:73.9893,i:.7726,w:170.531,T0:0}),Neptune:new a.c.Body("Neptune",{a:30.103658,e:.011214,M0:267.7649,n:217.9599,O:131.7942,i:1.768,w:37.4435,T0:0})};window.StarJs=a;a.Math=a.Math;a.Math.DEG2RAD=a.Math.u;a.Math.RAD2DEG=a.Math.ha;a.Math.RAD2ARCS=a.Math.ga;a.Math.ARCS2RAD=a.Math.C;a.Math.PI2=a.Math.v;a.Math.sqr=a.Math.ca;a.Math.frac=a.Math.B;a.Math.mod=a.Math.L;a.Math.Dms=a.Math.D;a.Math.dms2deg=a.Math.K;a.Math.D.prototype.dms2deg=a.Math.D.prototype.K;a.Math.D.deg2dms=a.Math.D.T;a.Math.angle2hms=a.Math.ia;a.Math.quadInterpolation=a.Math.ba;a.Math.sinh=a.Math.sinh;a.Math.cosh=a.Math.cosh;a.Coord=a.m;a.m.precessionEclMatrix=a.m.va;
a.m.precessionEquMatrix=a.m.wa;a.m.eclipticObliquity=a.m.N;a.m.equ2eclMatrix=a.m.oa;a.m.ecl2equMatrix=a.m.na;a.m.equ2hor=a.m.pa;a.m.hor2equ=a.m.sa;a.Kepler=a.f;a.f.eccAnomaly=a.f.U;a.f.elliptic=a.f.P;a.f.parabolic=a.f.aa;a.f.hypAnom=a.f.Z;a.f.hyperbolic=a.f.$;a.f.keplerPos=a.f.ta;a.f.gaussVec=a.f.V;a.Solar=a.c;a.c.EPS=a.c.M;a.c.approxMoon=a.c.J;a.c.approxSun=a.c.F;a.c.sunAndMoonEvents=a.c.xa;a.c.Sun=a.c.I;a.c.GM=a.c.S;a.c.Body=a.c.Body;a.c.BODIES=a.c.ea;a.Time=a.j;a.j.time2mjd=a.j.ya;a.j.mjd2dt=a.j.ua;
a.j.hms2hour=a.j.X;a.j.hour2hms=a.j.Y;a.j.dt2mjd=a.j.ma;a.j.mjd2jct=a.j.R;a.j.gmst=a.j.W;a.Vector=a.b;a.b.Vector3=a.b.l;a.b.l.prototype.len=a.b.l.prototype.G;a.b.l.prototype.add=a.b.l.prototype.add;a.b.l.prototype.sub=a.b.l.prototype.sub;a.b.l.prototype.neg=a.b.l.prototype.qa;a.b.l.prototype.scale=a.b.l.prototype.A;a.b.l.prototype.clone=a.b.l.prototype.o;a.b.Polar3=a.b.s;a.b.s.prototype.toVector3=a.b.s.prototype.o;a.b.s.prototype.clone=a.b.s.prototype.A;a.b.Matrix3=a.b.g;a.b.g.prototype.apply=a.b.g.prototype.apply;
a.b.g.prototype.mult=a.b.g.prototype.H;a.b.g.r_x=a.b.g.o;a.b.g.r_y=a.b.g.G;a.b.g.r_y=a.b.g.G;
