...
StarJs.Time.mjd2dt = function (mjd, jul) {
    if (typeof jul == 'undefined') jul = StarJs.Time.DEFAULT_JULIAN_JD;
...
StarJs.Time.dt2mjd = function (dt, jul) {
    if (typeof jul == 'undefined') jul = StarJs.Time.DEFAULT_JULIAN_DATE;
...
StarJs.Time.gmst = function (mjd) {
    ...
    t0 = (mjd0-51544.5)/36526.0;
    t = (mjd-51544.5)/36526.0;
    gmst = 24110.54841 + 8640184.812866*t0 + 1.0027379093*ut +
	(0.093104-(6.2e-6)*t)*t*t;
    return Math.PI/SECS*StarJs.Math.mod(gmst, SECS);
};
