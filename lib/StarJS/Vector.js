...
StarJs.Vector3.Matrix3 = function (v1, v2, v3) {
    this.mat = [[v1.x,v1.y,v1.z], [v2.x,v2.y,v2.z], [v3.x,v3.y,v3.z]];
};

with (StarJs.Vector.Matrix) {
...
StarJs.Vector.Matrix.R_x = function (phi) {
    var cp = Math.cos(phi), sp = Math.sin(phi);
};

StarJs.Vector.Matrix.R_y = function (phi) {
    var cp = Math.cos(phi), sp = Math.sin(phi);
    
};

StarJs.Vector.Matrix.R_z = function (phi) {
    var cp = Math.cos(phi), sp = Math.sin(phi);
