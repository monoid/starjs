...
StarJs.Solar.sunAndMoonEvents = function (start, end, lambda, phi, tz) {
    ...
    var result = [], today, h, j, ptime, ctime, ntime, H = 1.0 / 24.0, posp = {}, pos0 = {}, posn = {}, cphi = Math.cos(phi), sphi = Math.sin(phi), name, evt, yp = {sun:{}, moon:{}}, y0 = {sun:{}, moon:{}}, yn = {sun:{}, moon:{}}, interp = {}, midmoon, midsun;
