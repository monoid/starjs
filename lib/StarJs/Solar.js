StarJs.Solar = {};
window.StarJs['Solar'] = window.StarJs.Solar;
...
window.StarJs.Solar['approxMoon'] = window.StarJs.Solar.approxMoon;
...
window.StarJs.Solar['approxSun'] = window.StarJs.Solar.approxSun;
...
window.StarJs.Solar['sunAndMoonEvents'] = window.StarJs.Solar.sunAndMoonEvents;
...
window.StarJs.Solar['Sun'] = window.StarJs.Solar.Sun;

/** @const */
StarJs.Solar.Sun.$POS = new Math.Vector.Vector3(0, 0, 0);

/** @const */
StarJs.Solar.GM = StarJs.Math.sqr(0.01720209895);
window.StarJs.Solar['GM'] = window.StarJs.Solar.GM;

StarJs.Solar.Sun.prototype['keplerCoord'] = function (t) {
    return Math.Solar.Sun.$POS;
};
...
window.StarJs.Solar['Body'] = window.StarJs.Solar.Body;
