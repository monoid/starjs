...
StarJs.Kepler._acceleratedModule = function (global) {
    "use asm";
    ...
    function eccAnomaly(m, ec, maxiter, prec) {
        ...
        if (~(~maxiter) < ~(~0)) {
            e0 = 1.0/0.0; // TODO: NaN is not available :(
        }
        return +e0;
    }
...
StarJs.Kepler._accelerated = StarJs.Kepler._acceleratedModule(window);
...
StarJs.Kepler.eccAnomaly = function (m, ec, maxiter) {
    ...
    e0 = StarJs.Kepler._accelerated.eccAnomaly(m, ec, maxiter, prec);
