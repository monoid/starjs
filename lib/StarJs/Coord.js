StarJs.Coord = {};
window.StarJs['Coord'] = window.StarJs.Coord;
...
window.StarJs.Coord['precessionEclMatrix'] = window.StarJs.Coord.precessionEclMatrix;
...
StarJs.Coord['equ2eclMatrix'] = window.StarJs.Coord.equ2eclMatrix;

StarJs.Coord.ecl2equMatrix = function (jct) {
    var eps = (23.43929111 - (46.8150 + (0.00059 - 0.001813 * jct)) * jct) * jct * StarJs.ARCS2RAD;
    return StarJs.Vector.Matrix3.r_x(-eps);
};
StarJs.Coord['ecl2equMatrix'] = window.StarJs.Coord.ecl2equMatrix;
...
StarJs.Coord['equ2hor'] = window.StarJs.Coord.equ2hor;
...
StarJs.Coord['hor2equ'] = window.StarJs.Coord.hor2equ;
